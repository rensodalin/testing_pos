...
//   return (
//     <section className="bg-[#1b2130] h-[calc(100vh-5rem)] overflow-hidden">
//       <div className="flex items-center justify-between px-10 py-4">
//         <div className="flex items-center gap-4">
//           <BackButton />
//           <h1 className="text-[#f5f5f5] text-2xl font-bold tracking-wider">
...
//       <div className="grid grid-cols-5 gap-3 px-16 py-4 h-[200px] overflow-y-scroll scrollbar-hide">
//         {resData?.data.data
//           .filter((table) => status === "all" || table.status.toLowerCase() === status)
//           .map((table) => (
//             <TableCard
//               key={table._id}
//               id={table._id}
...
const Tables = () => {
  ...
  return (
    <section className="bg-[#1b2130] min-h-[calc(100vh-5rem)] px-4 pb-4 overflow-hidden">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 px-2 sm:px-6 overflow-y-auto scrollbar-hide">
        {resData?.data.data
          .filter(
